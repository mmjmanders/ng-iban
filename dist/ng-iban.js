...
angular.module('mm.iban', ['ng']).constant('countries', {
  AL: /^AL[0-9]{2}[0-9]{8}[0-9]{16}$/,
  AD: /^AD[0-9]{2}[0-9]{4}[0-9]{4}[0-9]{12}$/,
  AT: /^AT[0-9]{2}[0-9]{5}[0-9]{11}$/,
  AZ: /^AZ[0-9]{2}[A-Z]{4}[0-9]{20}$/,
  BH: /^BH[0-9]{2}[A-Z]{4}[0-9]{14}$/,
  BE: /^BE[0-9]{2}[0-9]{3}[0-9]{7}[0-9]{2}$/,
  BA: /^BA[0-9]{2}[0-9]{3}[0-9]{3}[0-9]{8}[0-9]{2}$/,
  BR: /^BR[0-9]{2}[0-9]{8}[0-9]{5}[0-9]{10}[A-Z]{1}[0-9]{1}$/,
  BG: /^BG[0-9]{2}[A-Z]{4}[0-9]{4}[0-9]{2}[0-9]{8}$/,
  CR: /^CR[0-9]{2}[0-9]{3}[0-9]{14}$/,
  HR: /^HR[0-9]{2}[0-9]{7}[0-9]{10}$/,
  CY: /^CY[0-9]{2}[0-9]{3}[0-9]{5}[0-9]{16}$/,
  CZ: /^CZ[0-9]{2}[0-9]{4}[0-9]{6}[0-9]{10}$/,
  DK: /^DK[0-9]{2}[0-9]{4}[0-9]{9}[0-9]{1}$/,
  DO: /^DO[0-9]{2}[0-9]{4}[0-9]{20}$/,
  EE: /^EE[0-9]{2}[0-9]{2}[0-9]{2}[0-9]{11}[0-9]{1}$/,
  FO: /^FO[0-9]{2}[0-9]{4}[0-9]{9}[0-9]{1}$/,
  FI: /^FI[0-9]{2}[0-9]{6}[0-9]{7}[0-9]{1}$/,
  FR: /^FR[0-9]{2}[0-9]{5}[0-9]{5}[0-9]{11}[0-9]{2}$/,
  GE: /^GE[0-9]{2}[A-Z]{2}[0-9]{16}$/,
  DE: /^DE[0-9]{2}[0-9]{8}[0-9]{10}$/,
  GI: /^GI[0-9]{2}[A-Z]{4}[0-9]{15}$/,
  GR: /^GR[0-9]{2}[0-9]{3}[0-9]{4}[0-9]{16}$/,
  GL: /^GL[0-9]{2}[0-9]{4}[0-9]{9}[0-9]{1}$/,
  GT: /^GT[0-9]{2}[0-9]{4}[0-9]{20}$/,
  HU: /^HU[0-9]{2}[0-9]{3}[0-9]{4}[0-9]{1}[0-9]{15}[0-9]{1}$/,
  IS: /^IS[0-9]{2}[0-9]{4}[0-9]{2}[0-9]{6}[0-9]{10}$/,
  IE: /^IE[0-9]{2}[A-Z]{4}[0-9]{6}[0-9]{8}$/,
  IL: /^IL[0-9]{2}[0-9]{3}[0-9]{3}[0-9]{13}$/,
  IT: /^IT[0-9]{2}[A-Z]{1}[0-9]{5}[0-9]{5}[0-9]{12}$/,
  KZ: /^KZ[0-9]{2}[0-9]{3}[0-9]{13}$/,
  KW: /^KW[0-9]{2}[A-Z]{4}[0-9]{22}$/,
  LV: /^LV[0-9]{2}[A-Z]{4}[0-9]{13}$/,
  LB: /^LB[0-9]{2}[0-9]{4}[0-9]{20}$/,
  LI: /^LI[0-9]{2}[0-9]{5}[0-9]{12}$/,
  LT: /^LT[0-9]{2}[0-9]{5}[0-9]{11}$/,
  LU: /^LU[0-9]{2}[0-9]{3}[0-9]{13}$/,
  MK: /^MK[0-9]{2}[0-9]{3}[0-9]{10}[0-9]{2}$/,
  MT: /^MT[0-9]{2}[A-Z]{4}[0-9]{5}[0-9]{18}$/,
  MR: /^MR[0-9]{2}[0-9]{5}[0-9]{5}[0-9]{11}[0-9]{2}$/,
  MU: /^MU[0-9]{2}[A-Z]{4}[0-9]{2}[0-9]{2}[0-9]{12}[0-9]{3}[A-Z]{3}$/,
  MD: /^MD[0-9]{2}[0-9]{20}$/,
  MC: /^MC[0-9]{2}[0-9]{5}[0-9]{5}[0-9]{11}[0-9]{2}$/,
  ...
  QA: /^QA[0-9]{2}[A-Z]{4}[0-9]{21}$/,
  RO: /^RO[0-9]{2}[A-Z]{4}[0-9]{16}$/,
  SM: /^SM[0-9]{2}[A-Z]{1}[0-9]{5}[0-9]{5}[0-9]{12}$/,
  SA: /^SA[0-9]{2}[0-9]{2}[0-9]{18}$/,
  RS: /^RS[0-9]{2}[0-9]{3}[0-9]{13}[0-9]{2}$/,
  SK: /^SK[0-9]{2}[0-9]{4}[0-9]{6}[0-9]{10}$/,
  SI: /^SI[0-9]{2}[0-9]{5}[0-9]{8}[0-9]{2}$/,
  ES: /^ES[0-9]{2}[0-9]{4}[0-9]{4}[0-9]{1}[0-9]{1}[0-9]{10}$/,
  SE: /^SE[0-9]{2}[0-9]{3}[0-9]{16}[0-9]{1}$/,
  CH: /^CH[0-9]{2}[0-9]{5}[0-9]{12}$/,
  TN: /^TN[0-9]{2}[0-9]{2}[0-9]{3}[0-9]{13}[0-9]{2}$/,
  TR: /^TR[0-9]{2}[0-9]{5}[0-9]{1}[0-9]{16}$/,
